...
//   if(bg.id === 'archive-page'){
//     bg.classList.add('archive')
//   } else {
//     bg.style.backgroundColor = primaryColor;
//   }
// }
...
// //The Rest
// const theDOM = document.querySelectorAll('article h2, article a, footer p,  footer ul,  footer a, hr, .attribution'); // returns array of all elements in the DOM
